...
class _CustomerSuggestionsPageState extends State<CustomerSuggestionsPage> {
  ...
  final List<Map<String, String>> _allSuggestions = [
    ...
    },
    {
      ...
      "type": "Jewelry",
      "avatar_asset": "assets/avatar.png",
      "suggestion_text": "I need a custom-designed pendant based on my sketch. The pendant should be suitable for 3D printing and subsequent casting in precious metals such as silver or gold. The design must include intricate patterns and textures, with a bail that allows it to be worn on various chains. I also want to experiment with alternative materials like resin or polymer for prototype versions before final metal casting. The pendant must maintain the balance and proportion of the original design and be polished so that it is ready for presentation or gifting. Small engravings and details are essential to match the sketch exactly.",
      "preview_image_url": "",
    ...
    },
    {
      ...
      "type": "Model",
      "avatar_asset": "assets/avatar.png",
      "suggestion_text": "I need an anatomically accurate 3D model of a human heart for educational purposes. The model should clearly differentiate chambers, valves, and vessels. It should be suitable for 3D printing in multiple colors to highlight different parts. I want it to be robust enough to handle repeated use in classrooms, yet lightweight for easy handling. Labels or markings for educational purposes are desired. The model will be used by students and teachers, so accuracy and clarity of details are very important.",
      "preview_image_url": "",
